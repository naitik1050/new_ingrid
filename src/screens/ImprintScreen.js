...
export default connect(mapStateToProps)(class ImprintScreen extends Component {
    constructor(props) {
        super(props);
    ...
    _renderScrollViewContent() {
        ...
        return (
            ...
            <HTML classesStyles={classesStyles} tagsStyles={tagStyles} containerStyle={{ ...s.mt20, ...s.m40}} html={this.imprint} imagesMaxWidth={Dimensions.get('window').width} />
            </View>
    ...
    render() {
        ...
        return (
            <View style={styles.fill}>
                ...
                >
                    <Text style={[s.h1, {flex: 1}]} numberOfLines={1}>{t.imprint}</Text>
                </Animated.View>
    ...
    componentWillMount() {
        ...
        this.imprint = this.props.imprint
