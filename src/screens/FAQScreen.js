...
const mapStateToProps = (state, ownProps) => {
    ...
    return {faq: state.faq, strings: state.strings};
};
...
export default connect(mapStateToProps)(class FAQScreen extends Component {
    constructor(props) {
        super(props);
    ...
    _renderScrollViewContent() {
        ...
        return (
            ...
            <HTML classesStyles={classesStyles} tagsStyles={tagStyles} containerStyle={{...s.mt20, ...s.m40}} html={this.faq} imagesMaxWidth={Dimensions.get('window').width} />
            </View>
    ...
    render() {
        ...
        return (
            <View style={styles.fill}>
                ...
                >
                    <Text style={[s.h1, {flex: 1}]} numberOfLines={1}>{t.notices}</Text>
                </Animated.View>
