...
class NameChangeScreen extends Component {
    state = {
        index: 0,
        settings: false,
        name: '',
    ...
    skipOrProceed = () => {
        if (this.index != 3) {
            this._swiper.scrollBy(3 - this.index);
    ...
    valueChanged(value, key) {
        ...
        if (typeof value !== 'undefined' && value.length) {
            ...
            Toast.show({
                text: 'Bitte sag mir deinen Namen oder klicke auf den Pfeil links oben.',
                buttonText: 'OK',
                        ...
                        <KeyboardAvoidingView style={[this.styles.slide1, s.paddingSmall]} behavior="position" enabled>
                            ...
                            <View style={this.styles.AnimationWrap}>
                                ...
                                <Lottie
                                    ...
                                    source={this.state.animations[3]}
...
export default connect(mapStateToProps, { nameChanged, saveSettings })(NameChangeScreen);
