...
const mapStateToProps = state => {
    return {ing: state.ingredients, favoritesList: state.favorites, sortedIng: state.sortedIngredients};
};

export default connect(mapStateToProps, {selectCat})(class IngredientsList extends React.Component {
    ...
    render() {
        ...
        if (typeof this.props.favorites !== 'undefined' && this.props.favorites == true && this.props.favoritesList) {
            this.data = this.props.favoritesList;

            data = Object.values(this.data).length ? dataProvider.cloneWithRows(Object.values(this.data)) : false;
        }
        ...
        if (data) {
            ...
            return <View style={[s.mt40, {
                ...
                height: 300,
                minHeight: 300
            }]}><Text style={[s.h2]}>Noch keine Favoriten</Text></View>;
        }
    ...
    componentWillMount() {
        ...
        this.data = {};
        if (typeof this.props.cat !== 'undefined' && this.props.cat) {

            this.data = this.props.sortedIng[this.props.cat] ? this.props.sortedIng[this.props.cat].ings : {};
        } else {
